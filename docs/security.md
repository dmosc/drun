...
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `fetch.allowlist`          | Domains reachable via `session_fetch` and Python outbound HTTP. PyPI CDNs are always included.                                      |
...
| `session.allowed_packages` | If set, `session_install_package` rejects any package not in the list.                                                              |
